# Importa a biblioteca do Google para inteligência artificial generativa
# que possibilita a criação de respostas e interações automáticas.
import google.generativeai as genai

# Importa a biblioteca de reconhecimento de fala, usada para converter
# áudio em texto, permitindo interações por comando de voz.
import speech_recognition as sr

# Importa a biblioteca de síntese de fala, que transforma texto em áudio.
# Isso permite que a aplicação responda em voz, tornando a interação mais completa.
import pyttsx3
...
# Saudação inicial
falar('Seja bem vindo chefe, como posso lhe servir')
